...
function draw(json){
  var graph = new JsonGraph(json).asJson();
  ...
  var link = svg.append("g")
      ...
      .style("stroke", function(e) { return d3.rgb("#EC008C");})
      .style("opacity", "0.7")
  ...
  //"#FFEC008C"
  node.append("rect")
      .attr("height", function(d) { return d.properties.weight; })
      .attr("width", function(d) { return d.dx}) // random chosen value to test
      .style("stroke", function(e) { return d3.rgb("#EC008C");})
      .style("fill", function(e) { return d3.rgb("#EC008C");})
      .style("opacity", "0.7")
    .append("title")
